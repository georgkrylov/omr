...
namespace TR
{
/** NOTE: This class is supposed to be inherited by RelocationTarget in consuming projects
 * In the proper OMR extensible classes technology way, the file name should be RelocationTarget.hpp
