 ...
 * project level classes that implement three methods: store Entry, load Entry,
 * and allocate Entry, with entry being a Method Header. This will allow OMR
 * AOT infrastructure to work with the preserved data
 */
class AOTStorage
   {
public:
